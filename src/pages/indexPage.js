...
const IndexPage = () => {
    ...
    return (
        <div className="container">
            {window === 1 && <div>
                <button className="btnIndex" style={{backgroundColor: loginOrRegister === 0 ? "green" : "darkgray"}}
                        onClick={() => {
                            setLoginOrRegister(0)
                        }}>Login
                </button>
                <button className="btnIndex" style={{backgroundColor: loginOrRegister === 1 ? "green" : "darkgray"}}
                        onClick={() => {
